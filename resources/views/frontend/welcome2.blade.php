...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <a href="{{ route('login') }}" class="get-started-btn scrollto ml-2">Coba bercerita</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p class="mt-3 mb-3">Dapatkan solusi lengkap dan komprehensif untuk merawat dan menjaga kesehatan mentalmu. Hidup sehat mental dan bahagia tinggal selangkah lagi.</p>
          <div class="d-flex">
